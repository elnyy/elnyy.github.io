---
title: "(スプレッドシート)表をHTMLのテーブルに変換してくれるサイト"
description: "スプレッドシートで作った表をHTMLのテーブルに変換してくれるサイトを紹介します"
...
手順としては、
1. スプレッドシートでテーブルに変換したい表を作成する
2. エクセルファイルとしてダウンロードする
3. サイトにエクセルファイルを読み込んで変換する


実践してみます。まずは、テーブルに変換したい表をスプレッドシートで作成します。
![](/images/spr-6-1.png)
